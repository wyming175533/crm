...
<script type="text/javascript">
	...
	//json[key]--->value,通过这种方式获取json中的value值
	$(function(){

		$("#create-stage").change(function (){

			var stage=$("#create-stage").val();//获取阶段下拉框选中内容
			$("#create-possibility").val(json[stage])//为可能性赋值
		})//获取possbility




		$("#create-customerName").typeahead({//姓名自动补全
			...
			delay: 1000//用于延时，当用户量大时，每次点击都访问数据库会增加服务器压力
		});
	...
	<div style="position:  relative; left: 30px;">
		<h3>创建交易</h3>
	  	<div style="position: relative; top: -40px; left: 70%;">
			<button type="button" class="btn btn-primary" id="save-transaction">保存</button>
			<button type="button" class="btn btn-default">取消</button>
		</div>
		<hr style="position: relative; top: -40px;">
	</div>
	<form class="form-horizontal" role="form" id="subform" style="position: relative; top: -30px;" action="workbench/transaction/save.do">
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				<input type="text" class="form-control" id="create-activitySrc" value="广告"/>
				<input type="hidden" value="3e89df9c146e4e4b864a2c5bb4cddf62" id="create-activityId" name="activityId">
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				<input type="text" class="form-control" id="create-contactsName" value="李四" >
				<input type="hidden" value="ad09124f9d184ff49e13241183442ef9" id="create-contactsId" name="contactsId">
			</div>
		</div>
