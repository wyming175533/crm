...
<% String basePath = request.getScheme() + "://" + request.getServerName() + ":" + request.getServerPort() + request.getContextPath() + "/";
	...
	Map<String,String> pmap= (Map<String, String>) application.getAttribute("map2");//从全局作用域取数据字典和解析过的配置文件值
...
<script type="text/javascript">
	...
	function changeStage(stage,i){
		$.ajax({
			...
			success: function (data) {
				/*
                data:{"success":true,{Tran}}
                 */
				if(data.success){
					$("#Change-stage").html(data.t.stage);
					$("#Change-editBy").html(data.t.editBy);
...
<body>
	...
	<div style="position: relative; top: 0px;">
		...
		<div style="position: relative; left: 40px; height: 30px; top: 20px;">
			...
			<div style="width: 300px;position: relative; left: 650px; top: -60px;" ><b id="Change-stage">${t.stage}</b></div>
			<div style="height: 1px; width: 400px; background: #D5D5D5; position: relative; top: -60px;"></div>
			<div style="height: 1px; width: 400px; background: #D5D5D5; position: relative; top: -60px; left: 450px;"></div>
		</div>
		<div style="position: relative; left: 40px; height: 30px; top: 30px;">
			...
			<div style="width: 300px;position: relative; left: 650px; top: -60px;"><b id="Change-possibility">${t.possibility}</b></div>
			<div style="height: 1px; width: 400px; background: #D5D5D5; position: relative; top: -60px;"></div>
			<div style="height: 1px; width: 400px; background: #D5D5D5; position: relative; top: -60px; left: 450px;"></div>
		</div>
		...
		<div style="position: relative; left: 40px; height: 30px; top: 70px;">
			...
			<div style="width: 500px;position: relative; left: 200px; top: -20px;"><b id="Change-editBy">${t.editBy}&nbsp;&nbsp;</b><small style="font-size: 10px; color: gray;" id="Change-editTime">${t.editTime}</small></div>
			<div style="height: 1px; width: 550px; background: #D5D5D5; position: relative; top: -20px;"></div>
		</div>
