		...
		$("#create-clue").click(function (){
			...
			$.ajax({
				...
				success: function (data) {
					...
					var id="${user.id}";//select选中id显示option中id所在的文本内容
					$("#create-owner").val(id);
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<form class="form-horizontal" role="form">
						...
						<div class="form-group">
							<label for="create-phone" class="col-sm-2 control-phone">公司座机</label>
							<div class="col-sm-10" style="width: 300px;">
		...
		<div style="width: 100%; position: absolute;top: 5px; left: 10px;">
			...
			<div class="btn-toolbar" role="toolbar" style="background-color: #F7F7F7; height: 50px; position: relative;top: 40px;">
				<div class="btn-group" style="position: relative; top: 18%;">
				  <button type="button" class="btn btn-primary" id="create-clue"><span class="glyphicon glyphicon-plus"></span> 创建</button>
